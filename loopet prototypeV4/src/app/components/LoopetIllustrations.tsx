...
export function LogoMark({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 44 44" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* House outline */}
      <path d="M5,22 L22,6 L39,22 L39,41 L5,41 Z" stroke="#F6511D" strokeWidth="3.5" strokeLinejoin="round"/>
      {/* Inner loop-heart: left arc */}
      <path d="M22,35 C15,34 10,29 11.5,24 C12.5,19 17,17.5 20,20.5" stroke="#F6511D" strokeWidth="2.6" strokeLinecap="round"/>
      {/* Inner loop-heart: right arc */}
      <path d="M22,35 C29,34 34,29 32.5,24 C31.5,19 27,17.5 24,20.5" stroke="#F6511D" strokeWidth="2.6" strokeLinecap="round"/>
      {/* Inner loop-heart: upper teardrop */}
      <path d="M20,20.5 C21,17 21.5,14 22,12 C22.5,14 23,17 24,20.5" stroke="#F6511D" strokeWidth="2.6" strokeLinecap="round"/>
    </svg>
  );
}
